...
private:
     ...
     * \return Whether this function added anything to the layer plan
     */
    bool processMultiLayerInfill(const SliceDataStorage& storage, LayerPlan& gcodeLayer, const SliceMeshStorage& mesh, const int extruder_nr, const PathConfigStorage::MeshPathConfigs& mesh_config, const SliceLayerPart& part) const;
     ...
     * \return Whether this function added anything to the layer plan
     */
    bool processSingleLayerInfill(const SliceDataStorage& storage, LayerPlan& gcodeLayer, const SliceMeshStorage& mesh, const int extruder_nr, const PathConfigStorage::MeshPathConfigs& mesh_config, const SliceLayerPart& part) const;
     ...
     * \param[out] added_something Whether this function added anything to the layer plan
     */
    void processRoofing(const SliceDataStorage& storage, LayerPlan& gcode_layer, const SliceMeshStorage& mesh, const int extruder_nr, const PathConfigStorage::MeshPathConfigs& mesh_config, const SkinPart& skin_part, bool& added_something) const;
    /*!
     ...
     * \param[out] added_something Whether this function added anything to the layer plan
     */
    void processTopBottom(const SliceDataStorage& storage, LayerPlan& gcode_layer, const SliceMeshStorage& mesh, const int extruder_nr, const PathConfigStorage::MeshPathConfigs& mesh_config, const SkinPart& skin_part, bool& added_something) const;
     ...
     */
    bool addSupportRoofsToGCode(const SliceDataStorage& storage, LayerPlan& gcode_Layer) const;

	bool addSupportInterfaceRoofsToGCode(const SliceDataStorage& storage, LayerPlan& gcode_Layer) const;
     ...
     * \return Whether any support skin was added to the layer plan.
     */
    bool addSupportBottomsToGCode(const SliceDataStorage& storage, LayerPlan& gcode_layer) const;

	bool addSupportInterfaceBottomsToGCode(const SliceDataStorage& storage, LayerPlan& gcode_layer) const;
...
public:
	...
	void setExtruder_addNestedPrime(const SliceDataStorage& storage, LayerPlan& gcode_layer, int extruder_nr) const;

	void setExtruder_addInterlacedPrime(const SliceDataStorage& storage, LayerPlan& gcode_layer, int extruder_nr)const;
...
private:
     ...
     */
    void addPrimeTower(const SliceDataStorage& storage, LayerPlan& gcodeLayer, int prev_extruder, bool extruder_changed=false) const;
