...
#ifndef Interlaced_PRIME_TOWER_H
#define Interlaced_PRIME_TOWER_H
...
private:
    ...
    std::vector<ExtrusionMoves> pattern_per_extruder; //!< For each extruder a vector of patterns to alternate between, over the layers
...
#endif // Interlaced_PRIME_TOWER_H
