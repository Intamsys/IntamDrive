...
public:
    ...
    double getHeatupSpeed(int extruder, bool during_printing)
    {
        return 1.0 / config_per_extruder[extruder].time_to_heatup_1_degree[during_printing];
    }

    double getTimeToCooldown1Degree(int extruder, bool during_printing)
    {
        return config_per_extruder[extruder].time_to_cooldown_1_degree[during_printing];
    }
    double getCooldownSpeed(int extruder, bool during_printing)
    {
        return 1.0 / config_per_extruder[extruder].time_to_cooldown_1_degree[during_printing];
    }
