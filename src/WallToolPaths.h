...
public:
     ...
     */
    WallToolPaths(const Polygons& outline, const coord_t nominal_bead_width, const size_t inset_count, const coord_t wall_0_inset, const SettingsBaseVirtual& settings);
     ...
     * \param settings The settings as provided by the user
     */
    WallToolPaths(const Polygons& outline, const coord_t bead_width_0, const coord_t bead_width_x, const size_t inset_count, const coord_t wall_0_inset, const SettingsBaseVirtual& settings);

    /*!
     * Generates the Toolpaths
     * \return A reference to the newly created ToolPaths. Binned by inset_idx.
     */
    const std::vector<VariableWidthLines>& generate(const SettingsBaseVirtual& settings);
     ...
     */
    const std::vector<VariableWidthLines>& getToolPaths(const SettingsBaseVirtual& settings);
     ...
     */
    void pushToolPaths(std::vector<VariableWidthLines>& paths, const SettingsBaseVirtual& settings);
     ...
     */
    const Polygons& getInnerContour(const SettingsBaseVirtual& settings);
...
protected:
     ...
     * \param settings The settings as provided by the user
     */
    static void stitchToolPaths(std::vector<VariableWidthLines>& toolpaths, const SettingsBaseVirtual& settings);
    ...
    static void simplifyAdjacentJunctions(std::vector<VariableWidthLines>& toolpaths, const SettingsBaseVirtual& settings);
     ...
     * \param settings The settings as provided by the user
     */
    static void simplifyToolPaths(std::vector<VariableWidthLines>& toolpaths, const SettingsBaseVirtual& settings);
