...
, fill_pattern_for_all_layers(new SierpinskiFill(*density_provider, fractal_config.aabb, fractal_config.depth, line_width, use_dithering))
{
}
...
SierpinskiFillProvider::~SierpinskiFillProvider()
{
    ...
    if (fill_pattern_for_all_layers)
    {
        delete fill_pattern_for_all_layers;
    }
}
