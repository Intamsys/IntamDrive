...
struct NozzleTempInsert
{
    ...
    double preheat_time;     
    double preheat_speed;   
    NozzleTempInsert(unsigned int path_idx, int extruder, double temperature, bool wait, bool enable_preheat = true, double time_after_path_start = 0.0);
