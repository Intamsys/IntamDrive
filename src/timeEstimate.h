...
private:
    double max_feedrate[NUM_AXIS] = {6000, 6000, 400, 250}; // mm/s
    double minimumfeedrate = 0.01;
    double acceleration = 30000;
    double max_acceleration[NUM_AXIS] = {90000, 90000, 1000, 90000};
    double max_xy_jerk = 200.0;
    double max_z_jerk = 4.0;
    double max_e_jerk = 50.0;
