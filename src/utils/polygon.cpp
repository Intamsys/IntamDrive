...
{
    Polygons poly_outer  = this->offset(outer_offset);
    Polygons poly_inner = this->offset(-inner_offset);
    Polygons poly_temp = poly_outer.difference(poly_inner);
